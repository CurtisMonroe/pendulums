        ...
        <div className="App">
            <header className="App-header">
                ...
                <svg style={{ border: '1px solid' }} width={width} height={height}>
                    <Pendulum index={1} anchor={spacing*1} color={'blue'} cx={spacing*1} cy={400} r={40} appState={state} />
                    <Pendulum index={2} anchor={spacing*2} color={'orange'} cx={spacing*2} cy={400} r={40} appState={state}/>
                    <Pendulum index={3} anchor={spacing*3} color={'yellow'} cx={spacing*3} cy={400} r={40} appState={state}/>
                    <Pendulum index={4} anchor={spacing*4} color={'green'} cx={spacing*4} cy={400} r={40} appState={state}/>
                    <Pendulum index={5} anchor={spacing*5} color={'cyan'} cx={spacing*5} cy={400} r={40} appState={state}/>
                </svg>
